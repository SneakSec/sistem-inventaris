...
<body class="p-4">
    ...
    <div class="text-center kop-surat">
        ...
        <p>Laporan Resmi Pengeluaran Barang Gudang</p>
    </div>

    <div class="text-center mb-4">
        <h5 class="fw-bold">LAPORAN BARANG KELUAR</h5>
        <p class="text-muted mb-0"><?= $periode; ?></p>
    </div>

    <table class="table table-bordered border-black">
        <thead class="table-danger text-center align-middle border-black">
            <tr>
                <th>No</th>
                <th>Tanggal</th>
                <th>Kode Barang</th>
        ...
        <tbody>
            ...
            $sql .= " ORDER BY tanggal ASC"; // Urutkan kronologis
            ...
            <tr>
                ...
                <td class="text-center fw-bold text-danger">- <?= $row['jumlah']; ?></td>
                <td><?= $row['penerima']; ?></td>
            </tr>
            <?php 
                endwhile; 
        ...
        <tfoot class="bg-light fw-bold">
            <tr>
                ...
                <td colspan="2" class="text-start ps-4 text-danger">- <?= $total; ?> Item</td>
            </tr>
        </tfoot>
    </table>
